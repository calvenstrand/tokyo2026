...
export const cities: City[] = [
  {
    ...
    days: [
      ...
      },
      {
        ...
        date: 'Monday, Nov 2',
        isoDate: '2026-11-02',
        label: 'Nakano + Samurai Restaurant',
        activities: [
          {
            time: 'Morning',
            title: 'Nakano Broadway',
            description: 'A few stops west of Shinjuku on the Chuo line — quick and easy. Retro gaming, collectibles, figures, vintage toys, multiple floors of dense, chaotic browsing. Mandarake has its best branch here — better stock and prices than Akihabara. Bring cash.',
          },
          {
            time: 'Afternoon / Evening',
            title: 'Samurai Restaurant — Kabukicho',
            description: 'High-energy dinner show in Kabukicho, Shinjuku\'s neon nightlife district — spiritual successor to the old Robot Restaurant. Glittering costumes, choreographed sword fights, dance, lights, noise. Book a show + drinks package (or show + meal) in advance. Reviews consistently rate it highly for pure entertainment value, though several note the food isn\'t the main event — better to eat separately before or after and treat this as spectacle rather than dinner. 18+, bring ID. Fits naturally into a Shinjuku evening — Golden Gai is a short walk away afterward if there\'s energy left.',
          },
          {
            time: 'Late',
            title: 'Golden Gai',
            description: 'One more stop before Kyoto packing, if the group has the energy. &Here SHINJUKU checkout is 11:00 — Shinkansen west on Day 5.',
          },
        ],
      },
    ],
