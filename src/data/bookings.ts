...
export const bookings: Booking[] = [
  ...
  },
  {
    ...
    cost: '¥3,300 × 4 = ¥13,200',
    description: 'Confirmed and paid — tickets secured via waitlist selection. Entry timing 15:30–16:00 JST. Interactive exhibits spanning Nintendo\'s entire history, playable installations, exclusive merch. Allow 3 hours minimum.',
  ...
  },
  {
    ...
    day: 'Day 7 · Nov 5 · Morning — TBD',
    deadline: 'Reallocated tour slots open ~late Sept/early Oct — check regularly, window is narrow',
    cost: 'TBD',
    description: 'Filling the currently-open Nov 5 morning before Nintendo Museum. Suntory reservations reopen for reallocated spots around late September/early October. If a slot doesn\'t come through, the morning stays flexible — a relaxed one, no rush before the 15:30 Nintendo Museum entry.',
