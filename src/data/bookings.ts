...
export const bookings: Booking[] = [
  ...
  // ── Tier 2 — Book 2–3 months before ──
  {
    ...
    description: 'Only 6 counter seats. Book the early sitting (6–7pm) given the late flight. NOTE: if baseball and omakase clash, move to Nov 13 after Nikko.',
...

  {
    ...
    description: 'Guided tasting tour of the historic Yebisu Brewery site. Nov 12 is a Thursday so availability should be fine, but book ahead regardless.',
